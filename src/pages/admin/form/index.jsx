...
class Form extends Component {
    ...
    addData = (data) => {
        ...
        let images = this.state.images.map((element) => element.base64);
        let newQuestion = {
        ...
        return (
            ...
            >
                ...
                <QuestionModal
                    ...
                    open={modalOpen}
                    handleImages={this.handlePicsSave}
                ...
                >
                    <TextField
                        id="faceSwitchingLimit"
                        label="Face Switching Limit"
                        type="number"
                        InputProps={{ inputProps: { min: 0 } }}
                        name="faceSwitchingLimit"
                        value={this.state.faceSwitchingLimit}
                        style={{ marginRight: "1rem", flex: 1 }}
                        onChange={(e) => {
                            this.setState({
                                faceSwitchingLimit: e.target.value,
                            });
                        }}
                    />
                    <TextField
                        id="tabSwitchingLimit"
                        label="Tab Switching Limit"
                        type="number"
                        name="tabSwitchingLimit"
                        value={this.state.tabSwitchingLimit}
                        InputProps={{ inputProps: { min: 0 } }}
                        style={{ marginLeft: "1rem", flex: 1 }}
                        onChange={(e) => {
                            this.setState({
                                tabSwitchingLimit: e.target.value,
                            });
                        }}
                    />
                </div>
